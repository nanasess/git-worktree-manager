...
setup_single_repo() {
    ...
    SINGLE_REPO_DIR="${TEST_WORK_DIR}/setup-php"
    WORKTREES_DIR="${TEST_WORK_DIR}/setup-php.worktrees"
    git clone --depth 1 https://github.com/nanasess/setup-php.git "$SINGLE_REPO_DIR" --quiet
}
